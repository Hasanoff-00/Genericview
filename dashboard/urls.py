...
from .views import FacultyList, FacultyDetail, GroupList, GroupDetail, StudentList, StudentDetail, KafedraList, KafedraDetail, SubjectList, SubjectDetail, TeacherList, TeacherDetail
